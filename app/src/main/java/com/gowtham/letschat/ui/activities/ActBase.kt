...
open class ActBase : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = IntentFilter(Constants.ACTION_LOGGED_IN_ANOTHER_DEVICE)
        ContextCompat.registerReceiver(this, newLogInReceiver, filter, ContextCompat.RECEIVER_NOT_EXPORTED)
