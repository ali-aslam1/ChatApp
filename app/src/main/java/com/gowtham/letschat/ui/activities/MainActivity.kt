...
import com.gowtham.letschat.utils.isValidDestination
...
class MainActivity : ActBase() {
    ...
    private val notificationPermissionRequestCode = 204
    ...
    private fun setDataInView() {
        try {
            ...
            binding.bottomNav.setOnItemSelectedListener(onBottomNavigationListener)
